...
from app.services.prediction_service import predict_disease, ANIMAL_TYPES, BREEDS_BY_ANIMAL, ALL_SYMPTOMS, meta
...
__all__ = [
    ...
    'predict_disease', 'ANIMAL_TYPES', 'BREEDS_BY_ANIMAL', 'ALL_SYMPTOMS', 'meta',
]